...
Q Support helps website administrators, developers and owners to solve technical issues and configuration problems with WordPress themes, widgets & plugins.

== Description ==

Q Support helps site owner, administrators and developers to solve technical issues and configuration problems with themes, widgets & plugins by connecting them to the FREE Q Support questions and answer website and it's community of users.
...
Please leave feedback here https://qstudio.us/support/categories/q-support-bugs
...
To enable this plugin to submit questions to the Q Support website, it's required to "connect" your current WordPress user ( the one you are logged into you own WordPress installation as ) to the Q Support website.

This process involves creating a new user account on Q Support - if you already have a Q Support user account and are using the same email - you will be "re-connected" to this account.

If you choose not to "connect" you account - the plugin cannot send or receive information from Q Support - which renders it practically useless - however, you could still post and follow up questions directly on the Q Support website, if you prefer.
...
* WP 4.4.1 Testing
* Moved into new Q Studio Support system
